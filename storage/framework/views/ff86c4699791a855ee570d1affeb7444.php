...
<body class="<?php echo e($landing->show_animation ? 'with-animation' : ''); ?>">
    ...
    <section id="home" class="h-screen bg-center bg-cover bg-no-repeat flex justify-center items-center"
        style="background-image: url('<?php echo e($landing->hero_image ? Storage::url($landing->hero_image) : 'images/hero-bg.png'); ?>');">
    ...
    <section id="mempelai" class="font-jost flex items-center gap-[60px] px-[80px] pt-[80px] pb-[120px] bg-[#f5f1eb]">
        <div class="relative w-[300px] h-[460px] flex-shrink-0">
            <?php $galleryBySlot = collect($gallery)->keyBy('slot'); ?>
            <img src="<?php echo e(isset($galleryBySlot['story1']) ? Storage::url($galleryBySlot['story1']['path']) : 'images/foto1.jpg'); ?>"
                class="absolute object-cover border-[3px] border-white w-[255px] h-[357px] top-0 left-0 z-[1]">
            <img src="<?php echo e(isset($galleryBySlot['story2']) ? Storage::url($galleryBySlot['story2']['path']) : 'images/foto2.jpg'); ?>"
                class="absolute object-cover border-[3px] border-white w-[206px] h-[257px] top-[150px] left-[180px] z-[2]">
            <img src="<?php echo e(isset($galleryBySlot['ucapan1']) ? Storage::url($galleryBySlot['ucapan1']['path']) : 'images/foto3.jpg'); ?>"
    ...
    <section id="acara" class="flex justify-between bg-[#321E04] items-stretch gap-[60px]">
        ...
        <div class="w-1/2 flex-1 relative self-stretch overflow-hidden m-0 text-[0] leading-[0]">
            <img src="<?php echo e(isset($galleryBySlot['save_the_date']) ? Storage::url($galleryBySlot['save_the_date']['path']) : 'images/foto4.jpg'); ?>"
    ...
    <section class="bg-white px-[80px] py-[80px]">
        <div class="flex items-start gap-[48px] mb-[48px]">
            <div class="w-[250px] h-[326px] flex-shrink-0 overflow-hidden rounded-[4px]">
                <img src="<?php echo e(isset($galleryBySlot['venue']) ? Storage::url($galleryBySlot['venue']['path']) : 'images/foto5.jpg'); ?>"
    ...
    <section class="relative w-full h-screen overflow-hidden"
        ...
        <div class="relative overflow-hidden" style="grid-column:1; grid-row:1/3;">
            ...
            <img src="<?php echo e(isset($galleryBySlot['dresscode1']) ? Storage::url($galleryBySlot['dresscode1']['path']) : 'images/woman1.jpg'); ?>"
                class="w-full h-full object-cover"/>
        </div>

        <div class="overflow-hidden" style="grid-column:2; grid-row:1;">
            <img src="<?php echo e(isset($galleryBySlot['dresscode2']) ? Storage::url($galleryBySlot['dresscode2']['path']) : 'images/man1.jpg'); ?>"
                class="w-full h-full object-cover"/>
        </div>
        ...
        <div class="overflow-hidden" style="grid-column:2; grid-row:2;">
            <img src="<?php echo e(isset($galleryBySlot['dresscode3']) ? Storage::url($galleryBySlot['dresscode3']['path']) : 'images/woman2.jpg'); ?>"
                class="w-full h-full object-cover"/>
        </div>
        <div class="overflow-hidden" style="grid-column:3; grid-row:2;">
            <img src="<?php echo e(isset($galleryBySlot['dresscode4']) ? Storage::url($galleryBySlot['dresscode4']['path']) : 'images/man2.jpg'); ?>"
        ...
        <div class="flex flex-row items-start gap-16 max-w-[860px] w-full mx-auto px-[60px] py-[80px]">
            ...
            <div class="flex flex-col flex-shrink-0 gap-[30px]">
                <div class="w-[275px] h-[275px] overflow-hidden">
                    <img src="<?php echo e(isset($galleryBySlot['story1']) ? Storage::url($galleryBySlot['story1']['path']) : 'images/story1.jpg'); ?>"
                        alt="Story 1" class="object-cover w-full h-full"/>
                </div>
                <div class="w-[275px] h-[275px] overflow-hidden">
                    <img src="<?php echo e(isset($galleryBySlot['story2']) ? Storage::url($galleryBySlot['story2']['path']) : 'images/story2.jpg'); ?>"
    ...
    <section id="galeri" class="bg-[#321E04] flex flex-col items-center px-[60px] py-[60px]">
        ...
        <div class="flex flex-row items-end justify-center gap-[30px] w-full max-w-[900px]">
            ...
            <div class="flex flex-col items-center gap-0">
                <div class="flex flex-row gap-[20px] mb-[24px]">
                    <div class="arch-wrapper">
                        <img src="<?php echo e(isset($galleryBySlot['ayah_pria']) ? Storage::url($galleryBySlot['ayah_pria']['path']) : 'images/dad1.jpg'); ?>" alt="Ayah Mempelai Pria"/>
                    </div>
                    <div class="arch-wrapper">
                        <img src="<?php echo e(isset($galleryBySlot['ibu_pria']) ? Storage::url($galleryBySlot['ibu_pria']['path']) : 'images/mom1.jpg'); ?>" alt="Ibu Mempelai Pria"/>
                    </div>
                </div>
            ...
            <div class="flex flex-col items-center gap-0">
                <div class="flex flex-row gap-[20px] mb-[24px]">
                    <div class="arch-wrapper">
                        <img src="<?php echo e(isset($galleryBySlot['ayah_wanita']) ? Storage::url($galleryBySlot['ayah_wanita']['path']) : 'images/dad2.jpg'); ?>" alt="Ayah Mempelai Wanita"/>
                    </div>
                    <div class="arch-wrapper">
                        <img src="<?php echo e(isset($galleryBySlot['ibu_wanita']) ? Storage::url($galleryBySlot['ibu_wanita']['path']) : 'images/mom2.jpg'); ?>" alt="Ibu Mempelai Wanita"/>
                    </div>
                </div>
                <div class="text-center">
                    <p class="font-jost font-normal text-white text-[24px] tracking-10">
        ...
        <div class="relative z-0 w-full overflow-x-auto overflow-y-hidden py-8 px-6">
            <div class="flex gap-4" style="width: max-content;">
                ...
                <?php else: ?>
                    ...
                    <?php $__currentLoopData = ['foto1','foto2','foto5','story1','story2','dad1','dad2','mom1','mom2']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="width:220px; height:320px; flex-shrink:0; overflow:hidden;">
                        <img src="images/<?php echo e($f); ?>.jpg" class="w-full h-full object-cover"/>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </div>
    ...
    <section class="bg-[#F8F8F8] flex items-center justify-center py-16 px-10">
        <div class="flex items-end justify-center gap-0" style="max-width:1200px;width:100%;">
            <div class="relative flex-shrink-0" style="width:520px;">
                <img src="<?php echo e(isset($galleryBySlot['penutup']) ? Storage::url($galleryBySlot['penutup']['path']) : 'images/story2.jpg'); ?>"
...
</html><?php /**PATH C:\laragon\www\undangan-pernikahan\resources\views/undangan/utama.blade.php ENDPATH**/ ?>