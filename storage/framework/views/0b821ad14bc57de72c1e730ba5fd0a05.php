...
<main class="main">
  ...
  <div class="content-area">
    ...
    <form method="POST" action="<?php echo e(route('landing.update')); ?>" enctype="multipart/form-data" id="landingForm">
    <?php echo csrf_field(); ?>
      ...
      <div class="card-content">
        ...
        <div class="form-row">
          <div>
            ...
            <input type="text" name="groom_name" class="inp" value="<?php echo e(old('groom_name', $landing->groom_name)); ?>" placeholder="Nama mempelai pria" />
          </div>
          <div>
            <label class="lbl">Mempelai Wanita</label>
            <input type="text" name="bride_name" class="inp" value="<?php echo e(old('bride_name', $landing->bride_name)); ?>" placeholder="Nama mempelai wanita" />
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="ayah_pria" class="inp" value="<?php echo e(old('ayah_pria', $landing->ayah_pria)); ?>" placeholder="Nama ayah mempelai pria" />
          </div>
          <div>
            <label class="lbl">Ayah Mempelai Wanita</label>
            <input type="text" name="ayah_wanita" class="inp" value="<?php echo e(old('ayah_wanita', $landing->ayah_wanita)); ?>" placeholder="Nama ayah mempelai wanita" />
          </div>
        </div>
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label class="lbl">Ibu Mempelai Pria</label>
            <input type="text" name="ibu_pria" class="inp" value="<?php echo e(old('ibu_pria', $landing->ibu_pria)); ?>" placeholder="Nama ibu mempelai pria" />
          </div>
          <div>
            <label class="lbl">Ibu Mempelai Wanita</label>
            <input type="text" name="ibu_wanita" class="inp" value="<?php echo e(old('ibu_wanita', $landing->ibu_wanita)); ?>" placeholder="Nama ibu mempelai wanita" />
          </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-4">
          <div>
            ...
            <div class="inp-icon-wrap">
              ...
              <input type="date" name="wedding_date" class="inp" value="<?php echo e(old('wedding_date', $landing->wedding_date ? \Carbon\Carbon::parse($landing->wedding_date)->format('Y-m-d') : '')); ?>" />
            </div>
          </div>
          <div>
            <label class="lbl">Lokasi / Gedung</label>
            <input type="text" name="lokasi_wedding" class="inp" value="<?php echo e(old('lokasi_wedding', $landing->lokasi_wedding)); ?>" placeholder="Nama gedung / tempat" />
          </div>
          <div>
            <label class="lbl">Kota</label>
            <input type="text" name="kota" class="inp" value="<?php echo e(old('kota', $landing->kota)); ?>" placeholder="Kota pelaksanaan" />
          </div>
        </div>

        <div>
          <label class="lbl-dark">Google Maps Embed (iframe)</label>
          <textarea name="map_iframe" class="inp" placeholder='<iframe src="https://www.google.com/maps/embed?...">' style="min-height:80px;"><?php echo e(old('map_iframe', $landing->map_iframe)); ?></textarea>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div style="display:flex;flex-direction:column;gap:12px;">
            <div>
              ...
              <textarea name="dresscode_text" class="inp" placeholder="Deskripsi dress code…"><?php echo e(old('dresscode_text', $landing->dresscode_text)); ?></textarea>
            </div>
            <div>
        ...
        <div style="display:flex;flex-direction:column;gap:16px;">
          <div>
            ...
            <textarea name="cerita_bertemu" class="inp" placeholder="Ceritakan bagaimana kalian pertama bertemu…"><?php echo e(old('cerita_bertemu', $landing->cerita_bertemu)); ?></textarea>
          </div>
          <div>
            <label class="lbl-dark">Cerita Melamar</label>
            <textarea name="cerita_melamar" class="inp" placeholder="Ceritakan momen lamaran…"><?php echo e(old('cerita_melamar', $landing->cerita_melamar)); ?></textarea>
          </div>
        </div>
    ...
    <div class="card">
      ...
      <div class="card-content">
        <div>
          ...
          <input type="hidden" id="selected_template" name="template" value="<?php echo e(old('template', $landing->template ?? 'bohemian')); ?>" />
          <div class="grid grid-cols-2 gap-4" style="margin-top:8px;">
            <div id="tpl-bohemian" onclick="selectTemplate('bohemian')" class="tpl-card <?php echo e(($landing->template ?? 'bohemian') === 'bohemian' ? 'selected' : ''); ?>">
            ...
            <div id="tpl-modern" onclick="selectTemplate('modern')" class="tpl-card <?php echo e(($landing->template ?? 'bohemian') === 'modern' ? 'selected' : ''); ?>">
              <div class="aspect-video flex items-center justify-center"
      ...
      <div class="card">
        ...
        <div class="settings-content">
          <div class="flex items-center justify-between py-[11px]">
            ...
            <label class="cursor-pointer"><input type="checkbox" id="tog-animasi" name="show_animation" class="tog-input" <?php echo e($landing->show_animation ? 'checked' : ''); ?> /><div class="tog-track"></div></label>
          </div>
          <div class="flex items-center justify-between py-[11px]">
            <div>
            ...
            <label class="cursor-pointer"><input type="checkbox" id="tog-musik" name="play_music" class="tog-input" <?php echo e($landing->play_music ? 'checked' : ''); ?> /><div class="tog-track"></div></label>
          </div>
          <div class="flex items-center justify-between py-[11px]">
            <div>
            ...
            <label class="cursor-pointer"><input type="checkbox" id="tog-nama" name="show_guest_name" class="tog-input" <?php echo e($landing->show_guest_name ? 'checked' : ''); ?> /><div class="tog-track"></div></label>
          </div>
          <div class="flex items-center justify-between py-[11px]">
            <div>
            ...
            <label class="cursor-pointer"><input type="checkbox" id="tog-privat" name="is_private" class="tog-input" <?php echo e($landing->is_private ? 'checked' : ''); ?> /><div class="tog-track"></div></label>
          </div>
        </div>
      </div>
          ...
          <div style="border-radius:8px;overflow:hidden;width:100%;min-height:200px;">
            <div style="width:100%;min-height:200px;display:flex;align-items:center;justify-content:center;position:relative;background:linear-gradient(160deg,#3A2010 0%,#7A5230 40%,#C4A07A 100%);">
              <div style="text-align:center;color:#fff;">
                ...
                <p style="font-family:'Playfair Display',serif;font-size:18px;line-height:1.375;"><?php echo e($landing->groom_name ?? 'Groom'); ?><br><span style="font-size:13px;color:rgba(255,255,255,.5);">&</span><br><?php echo e($landing->bride_name ?? 'Bride'); ?></p>
...
</html><?php /**PATH C:\laragon\www\undangan-pernikahan\resources\views/dashboard/editlanding.blade.php ENDPATH**/ ?>