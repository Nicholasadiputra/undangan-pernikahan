...
<main class="main">
  <div class="page-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    <h1 class="page-title" style="margin-bottom: 0;">Edit Landing Page</h1>
    <button type="submit" form="landingForm" class="btn-save">SAVE</button>
  </div>
    ...
    <div class="content-grid">
      ...
      <div class="card full-col">
        ...
        <div class="template-grid">
          <div class="template-item {{ (old('template', $landing->template ?? 'bohemian') == 'bohemian') ? 'selected' : '' }}" id="tpl-bohemian" onclick="selectTemplate('bohemian')">
          ...
          <div class="template-item {{ (old('template', $landing->template ?? '') == 'modern') ? 'selected' : '' }}" id="tpl-modern" onclick="selectTemplate('modern')">
