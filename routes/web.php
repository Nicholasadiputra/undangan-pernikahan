...
Route::prefix('dashboard')->middleware('admin')->group(function () {
    ...
    // RUTE TAMBAHAN UNTUK UPLOAD GALLERY (PROTECTED - Hanya gunakan middleware 'admin')
    Route::post('/landing/upload-gallery', [LandingController::class, 'uploadGallery'])->name('landing.uploadGallery');
